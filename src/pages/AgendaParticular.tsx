                ...
                <div className="flex flex-wrap items-end gap-4">
                    <div className="space-y-1">
                        ...
                        <AsyncSelect
                            ...
                            value={filterClientId === ALL_CLIENTS ? "" : filterClientId}
                            onChange={(val) => setFilterClientId(val || ALL_CLIENTS)}
                    ...
                    <div className="space-y-1">
                        ...
                        <AsyncSelect
                            ...
                            value={filterUserId === ALL_USERS ? "" : filterUserId}
                            onChange={(val) => setFilterUserId(val || ALL_USERS)}
                    ...
                    <div className="space-y-4 py-2">
                        ...
                        <div className="space-y-1">
                            ...
                            <AsyncSelect
                                ...
                                value={formClientId === NONE_CLIENT ? "" : formClientId}
                                onChange={(val) => setFormClientId(val || NONE_CLIENT)}
                                getLabel={(c: any) => c.tradeName || c.legalName}
                                getValue={(c: any) => c.id}
                        ...
                        <div className="space-y-1">
                            ...
                            <AsyncSelect
                                ...
                                value={formUserId === NONE_USER ? "" : formUserId}
                                onChange={(val) => setFormUserId(val || NONE_USER)}
                                getLabel={(u: any) => u.name}
                                getValue={(u: any) => u.id}
